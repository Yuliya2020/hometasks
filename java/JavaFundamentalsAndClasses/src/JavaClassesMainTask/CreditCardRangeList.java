...
public class CreditCardRangeList extends Customer {

    public CreditCardRangeList(int id, String surname, String name, String fathersName, String address, String creditCardNumber, String accountNumber) {
    ...
    public static void main(String[] args) {
        ...
        String number = "5159875624853356";
        for (int j = 0; j < customer.length; j++) {
            if (customer[j].getCreditCardNumber() == number) {
